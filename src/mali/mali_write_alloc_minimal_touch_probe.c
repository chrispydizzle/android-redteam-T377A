...
int main(void)
{
    static const struct refresh_case cases[] = {
        ...
        { "touch-word0", TOUCH_WORD0 },
        { "touch-word4", TOUCH_WORD4 },
        { "touch-word8", TOUCH_WORD8 },
        { "touch-word9", TOUCH_WORD9 },
        { "touch-word10", TOUCH_WORD10 },
        { "touch-full-desc", TOUCH_FULL_DESC }
    };
    size_t i;
    pid_t pid;
    int status = 0;

    printf("=== Mali write-alloc minimal-touch probe ===\n");
