...
int main(void)
{
    static const struct refresh_case cases[] = {
        ...
        { "touch-first16-same", TOUCH_FIRST16_SAME },
        { "touch-first16-zero", TOUCH_FIRST16_ZERO },
        { "touch-first16-pattern", TOUCH_FIRST16_PATTERN },
        { "touch-word0-zero", TOUCH_WORD0_ZERO },
        { "touch-word123-zero", TOUCH_WORD123_ZERO },
    ...
    printf("=== Mali write-alloc epoch probe ===\n");
